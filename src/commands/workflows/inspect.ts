...
export default class Sync extends Command {
    ...
    async inspect(client: typeof api, flags: { path?: string, explicit?: Boolean, verbose?: Boolean }, args: any): Promise<void> {
        ...
        const workflows = (
            ...
            var cleanedInputs = inputs.map((ixl: { createdBy?: string, createdAt?: string, id?: string, key?: string, name?: string, owner?: string }) => {
        ...
        var tree: archy.Data = this._transformToArchy(workflows.find(({ id }: any) => id === args.id), "workflow", true)
